...
import { LocaleState, LocaleStatus, TOGGLE_LOCALED } from '../store/locale'
	...
	const selectLanguageMenu = (
		<Menu onClick={toggleLanguage}>
			<Menu.Item 
				...
				disabled={locale.locale === LocaleStatus.ZH_CN}
			...
			<Menu.Item 
				style={{ textAlign: 'left' }}
				disabled={locale.locale === LocaleStatus.ZH_TW}
			...
			<Menu.Item 
				style={{ textAlign: 'left' }}
				disabled={locale.locale === LocaleStatus.US_EN}
